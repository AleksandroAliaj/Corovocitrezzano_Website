...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/h3/dist/index.mjs';
import { GoogleGenerativeAI } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/@google/generative-ai/dist/index.mjs';
import { useDb } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/composables/db.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/devalue/index.js';
import destr from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/aleksandroaliaj/Documents/coro_oratorio/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/aleksandroaliaj/Documents/coro_oratorio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aleksandroaliaj/Documents/coro_oratorio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aleksandroaliaj/Documents/coro_oratorio/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aleksandroaliaj/Documents/coro_oratorio/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aleksandroaliaj/Documents/coro_oratorio/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aleksandroaliaj/Documents/coro_oratorio/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _a1zVrA0Kgu = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/aleksandroaliaj/Documents/coro_oratorio";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _eFfr7WQTu9 = (nitroApp) => {
...
const _lazy_fzMCBF = () => Promise.resolve().then(function () { return chatbot_post$1; });
const _lazy_YTT0W6 = () => Promise.resolve().then(function () { return people_get$1; });
const _lazy_vdFJQo = () => Promise.resolve().then(function () { return project_get$1; });
const _lazy_PD5D9b = () => Promise.resolve().then(function () { return review_get$1; });
const _lazy_lNHZeI = () => Promise.resolve().then(function () { return review_post$1; });
const _lazy_WlZe6F = () => Promise.resolve().then(function () { return service_get$1; });
const _lazy_Q6oLL4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/chatbot', handler: _lazy_fzMCBF, lazy: true, middleware: false, method: "post" },
  { route: '/api/people', handler: _lazy_YTT0W6, lazy: true, middleware: false, method: "get" },
  { route: '/api/project', handler: _lazy_vdFJQo, lazy: true, middleware: false, method: "get" },
  { route: '/api/review', handler: _lazy_PD5D9b, lazy: true, middleware: false, method: "get" },
  { route: '/api/review', handler: _lazy_lNHZeI, lazy: true, middleware: false, method: "post" },
  { route: '/api/service', handler: _lazy_WlZe6F, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_Q6oLL4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Q6oLL4, lazy: true, middleware: false, method: undefined }
];
...
const chatbot_post = defineEventHandler(async (e) => {
  try {
...
const chatbot_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: chatbot_post
});

const people_get = defineEventHandler(async (e) => {
  const { data } = await useDb().from("person").select();
  return data;
});

const people_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: people_get
});

const project_get = defineEventHandler(async (e) => {
  const { data } = await useDb().from("project").select();
  return data;
});

const project_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: project_get
});

const review_get = defineEventHandler(async (e) => {
  const { data } = await useDb().from("review").select();
  return data;
});

const review_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: review_get
});

const review_post = defineEventHandler(async (e) => {
  try {
...
const review_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: review_post
});

const service_get = defineEventHandler(async (e) => {
  const { data } = await useDb().from("service").select();
  return data;
});

const service_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: service_get
});
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[{}],"noscript":[],"title":"Brave Sisters","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/aleksandroaliaj/Documents/coro_oratorio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/aleksandroaliaj/Documents/coro_oratorio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
